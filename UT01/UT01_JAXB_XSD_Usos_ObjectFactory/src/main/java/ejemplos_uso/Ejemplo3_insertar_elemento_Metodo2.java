...
public class Ejemplo3_insertar_elemento_Metodo2 {
	...
	public static void insertarElementoXML() {
		...
		JAXBElement<Centros> centrosElement = factory.createCentros(todosCentros);
		...
		try {
			...
			m.marshal(centrosElement, System.out);
			// Generar en disco el archivo XML
			m.marshal(centrosElement, new File(rutaNuevoXMLCentrosProfes));
